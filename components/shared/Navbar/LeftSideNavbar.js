  ...
  return (
    <>
      ...
      <div className="sticky top-0 bg-gray-800 h-full text-white mt-0.5 overflow-y-visible ">
        <div className="flex items-center gap-4 cursor-pointer hover:bg-common px-[10px] py-[5px] h-10">
        ...
        <>
          <div
            ...
            className="flex items-center gap-4 cursor-pointer hover:bg-common px-4 py-2">
            <IoLogoDropbox />{" "}
            <span className="font-semibold">Primary Education</span>
          </div>
          {showPrimary && (
            <div className="flex flex-col pl-4">
              <li className="flex items-center gap-3 cursor-pointer hover:bg-[#7f7f7f] px-[10px] py-[3px] h-6">
                <a>Class-1</a>
              </li>
              <li className="flex items-center gap-3 cursor-pointer hover:bg-[#7f7f7f] px-[10px] py-[3px] h-6">
                <a>Class-2</a>
          ...
          <div className="flex items-center gap-4 cursor-pointer hover:bg-common px-4 py-2">
            <IoLogoDropbox />{" "}
